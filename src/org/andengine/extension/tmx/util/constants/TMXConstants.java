...
public interface TMXConstants {
	...
	public static final String TAG_SHAPE_POLYLINE = "polyline";
	public static final String TAG_SHAPE_POLYGON = "polygon";
	public static final String TAG_SHAPE_ATTRIBUTE_POINTS = "points";
